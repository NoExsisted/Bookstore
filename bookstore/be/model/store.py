...
#             # },
#
#         self.stores.insert_one(store_data)
#
...
#
#
#     def init_new_order_paid_collection(self):
#         # 初始化新订单集合
#         try:
#             new_order_paid = self.db["new_order_paid"]
#             new_order_paid.create_index([("order_id", 1)], unique=True)  # 确保order_id是唯一的
#
#             # 插入初始数据，根据需要定义和插入新订单文档
#             new_order_data = {
#                     "order_id": "order1",
...
#                 }
#
#             new_order_paid.insert_one(new_order_data)
#         except Exception as e:
#             logging.error(e)
#
#
